...
cron.schedule('*/40 * * * * *', ()=>{
   ...
   saveData(res,'donneestrasbourg')
    ...
    url_GransPoitiers ='https://data.grandpoitiers.fr/api/records/1.0/search/?dataset=mobilites-stationnement-des-parkings-en-temps-reel&q=&facet=nom&timezone=Europe/Paris'
